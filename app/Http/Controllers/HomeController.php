...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $toko = Toko::all();
        $voucher = Voucher::all();
        $voucherpake = Voucher::where('status', 'like', '%'.'terpakai'.'%')->orderBy('kode','ASC')->paginate(10);
        $cust = Customers::latest()->paginate(10);
        return view('home', compact('cust','cabang','voucher','toko','voucherpake'));
    }
